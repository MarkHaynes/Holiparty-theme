    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(<?php bloginfo('template_url'); ?>/images/slider/loading.gif) no-repeat center center;
                top: 0px; left: 0px; width: 100%; height: 100%;">
            </div>
        </div>
        <!-- Slides Container -->
        ...
        <style>
            ...
            */
            ...
            .jssorb21 div, .jssorb21 div:hover, .jssorb21 .av {
                ...
                color: white;
                font-size: 12px;
                background: url(<?php bloginfo('template_url'); ?>/images/slider/b21.png) no-repeat;
                overflow: hidden;
                cursor: pointer;
            }
        ...
        <style>
            ...
            */
            .jssora21l, .jssora21r {
                ...
                height: 55px;
                cursor: pointer;
                background: url(<?php bloginfo('template_url'); ?>/images/slider/a21.png) center center no-repeat;
                overflow: hidden;
            }
